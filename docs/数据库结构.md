...
CREATE TABLE `news_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 CHARACTER SET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='医疗新闻分类表';
...
CREATE TABLE `medical_news` (
  ...
  `cover_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '封面图片',
  `summary` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '摘要',
  `view_count` int DEFAULT 0 COMMENT '浏览量',
  `status` tinyint DEFAULT 1 COMMENT '状态(0草稿,1已发布,2下架)',
  `is_top` tinyint DEFAULT 0 COMMENT '是否置顶(0否,1是)',
  `related_illness_id` int DEFAULT NULL COMMENT '关联疾病ID',
  `related_medicine_id` int DEFAULT NULL COMMENT '关联药品ID',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  INDEX `idx_category` (`category_id`),
  INDEX `idx_illness` (`related_illness_id`),
  INDEX `idx_medicine` (`related_medicine_id`),
  INDEX `idx_publish_time` (`publish_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 CHARACTER SET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='医疗新闻文章表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 CHARACTER SET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文章收藏表'; 
